...
module DateTimes {
    ...
    export module Timestamp {
         ...
         */
        export function toDotNetJson(timestamp: TimestampUtc, includeOffset: boolean = true): string {
            return DotNetJsonDate.toDotNetJson(Timestamp.toDate(timestamp), includeOffset);
        }
         ...
         */
        export function toUtcDotNetJson(timestamp: TimestampUtc): string {
            return DotNetJsonDate.toDotNetJson(new Date(<number>timestamp + Timestamp.currentTimezoneOffsetMillis));
        }
