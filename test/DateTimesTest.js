...
suite("DateTimes", function DateTimesTest() {
    function testDotNetJson(asr) {
        ...
        asr.equal(DotNetJsonDate.parseDotNetJson(Timestamps.toDotNetJson(null)).getTime(), new Date(0).getTime());
        asr.equal(DotNetJsonDate.parseDotNetJson(Timestamps.toDotNetJson(0)).getTime(), new Date(0).getTime());
    }
    function testDotNetJsonTimestamp(asr) {
        ...
        asr.equal(Timestamps.parseDotNetJson(Timestamps.toDotNetJson(null)), new Date(0).getTime());
        asr.equal(Timestamps.parseDotNetJson(Timestamps.toDotNetJson(0)), new Date(0).getTime());
    }
    ...
    test("Timestamp.toDisplayDateTime", function toDisplayDateTimeTest() {
        ...
        var res1 = Timestamps.toDisplayDateTime(new Date(1920, 5, 3, 15, 21).getTime(), false);
